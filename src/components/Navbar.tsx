      ...
      <div className="md:hidden fixed top-4 right-4 z-50">
        ...
        {open && (
          <div className="absolute right-0 mt-2 w-40 bg-gray-800 text-white p-4 text-lg font-['Bariol_Regular'] rounded-xl shadow-lg">
            <Link href="/" className="block py-1 hover:text-orange-300">Home</Link>
            <Link href="/aboutme" className="block py-1 hover:text-orange-300">About Me</Link>
            <Link href="/projects" className="block py-1 hover:text-orange-300">Projects</Link>
            <Link href="/skills" className="block py-1 hover:text-orange-300">Skills</Link>
            <Link href="/contactme" className="block py-1 hover:text-orange-300">Contact Me</Link>
          </div>
        )}
      </div>
    </>
